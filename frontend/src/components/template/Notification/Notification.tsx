            ...
            setNotificationList(prev => [
                {
                    ...
                    image: '/img/others/lead.png',
                    type: 1,
                    location: `/leads/${lead.id}`,
                    locationLabel: 'View Lead',
                    status: 'new',
                    readed: false,
                },
                ...prev,
            ...
            <Dropdown.Item variant="header">
                <div className="pt-4">
                    <Button
                        ...
                        className="bg-gradient-to-r from-[#be2073] to-[#812c83] hover:from-[#812c83] hover:to-[#be2073] text-white border-0"
                    >
                        View All Activity
                    </Button>
                </div>
